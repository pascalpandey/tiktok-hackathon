  ...
  return (
    <>
      ...
      {show && (
        <div>
          <div
            className="absolute flex w-screen h-screen top-0 left-0 bg-black opacity-20"
            onClick={() => setShow(false)}
          />
          <div className="bg-white p-8 w-96 rounded-md h-[400px] flex flex-col gap-4 absolute top-[calc((100vh-400px)/2)] left-[calc((100vw-384px)/2)]">
