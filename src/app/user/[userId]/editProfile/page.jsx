        ...
        <div className='w-full'>
            <div className=' mx-auto relative w-fit'>
                <form onSubmit={handleSubmit(handleEditProfile)}>
                        ...
                        <div className='mb-8 w-fit'>
                            <div className='relative '>
                                ...
                                <label for="file" className='text-sm'>Profile Photo
                                    <Image className='w-28 h-28 rounded-full border mt-1' />
                            ...
                            <div className='mt-2 mb-1 '>
                                <div className='flex flex-col'>
                                    ...
                                    <textarea
                                        ...
                                        className="p-2 bg-gray-50 h-32 text-black mb-4 rounded"
                                        {...register("bio")}
                                    />
                                </div>
                    ...
                    <button type="submit" className='mt-12 absolute right-0 hover:bg-red-50 transition border-ttred text-ttred border p-2 rounded'>Save Changes</button>
                </form>
            </div>
        </div>
    )
